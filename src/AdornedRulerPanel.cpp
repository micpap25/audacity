...
EnumSetting<AdornedRulerPanel::RulerType> RulerPanelViewPreference{
   L"/GUI/RulerType",
   {
      { wxT("Minutes and Seconds"), XO("Minutes and Seconds") },
      { wxT("Beats and Measures"), XO("Beats and Measures") },
   },
...
{
   int id = event.GetId();
   RulerType changeFlag = mRulerType;
